...
//                             <th style={{ borderBottom: '1px solid #ccc', padding: '8px' }}> Rs.{customer.delivery_charges} </th>
//                         </tr>
//                         <tr>
//                             <th style={{ borderBottom: '1px solid #ccc', padding: '8px' }} colSpan={2} ></th>
//                             <th style={{ borderBottom: '1px solid #ccc', padding: '8px' }}>Grand Total</th>
//                             <th style={{ borderBottom: '1px solid #ccc', padding: '8px' }}> Rs.${(Number(customer.delivery_charges) + Number(total)).toFixed(2)} </th>
//                         </tr>
//                     </tfoot>
//                 </table>
...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    const InvoiceTemplate = `
      ...
      <body style="font-family: Arial, sans-serif; max-width: 100%; margin: 0 auto; margin-top: 10px;">
      <p style="font-size: 14px;">Thank you for shopping with us! Your order will be delivered within 1-2 working days. Here is the Invoice of Your Order</p>
        <div style="border-bottom: 1px solid lightgray; padding-bottom: 10px; margin-bottom: 10px; margin-top: 10px; display: flex; justify-content: start; align-items: center;">
          <img width="200px" height="40px" src="https://www.nhealthcare.com.pk/assets/img/logo/nlogo.png" alt="logo" />
        </div>
        <div style="display: flex; justify-content: space-between; align-items: start;">
          <table style="width: 45%;">
            <tr><th style="text-align:left" >Invoice To</th></tr>
        ...
        <div style="margin-top: 20px;">
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tfoot>
              <tr>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left" colSpan="2"></th>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left">Subtotal</th>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left">Rs.${total.toFixed(2)}</th>
              </tr>
              <tr>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left" colSpan="2"></th>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left">Delivery Charges</th>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left">Rs.${customer.delivery_charges}</th>
              </tr>
              <tr>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left" colSpan="2"></th>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left">Grand Total</th>
                <th style="border-bottom: 1px solid #ccc; padding: 8px; text-align:left">Rs.${(Number(customer.delivery_charges) + Number(total)).toFixed(2)}</th>
              </tr>
            </tfoot>
          </table>
        ...
        <p style="font-size: 14px; margin-top: 20px;">Feel free to reach out to us for any queries:</p>
        <p style="font-size: 14px; margin-top: 5px;">Email: info@nhealthcare.com.pk</p>
        <p style="font-size: 14px; margin-top: 5px;">Whatsapp: +92-326-8037143</p>
        <p style="font-size: 14px; margin-top: 5px;">www.nhealthcare.com.pk</p>
    ...
    const mailOptions = {
      ...
      replyTo: process.env.yourEmail,
      to: customer.email,
      subject: 'Thank you for Your Order - Order Invoice',
      html: InvoiceTemplate
    };
